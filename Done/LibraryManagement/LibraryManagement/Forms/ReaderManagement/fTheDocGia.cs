...
namespace LibraryManage
{
    public partial class Form1 : Form
    {
        ...
        private void dgvDSDocGia_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //String s = dgvDSDocGia.CurrentRow.Cells[8].Value.ToString();
            //double s = double.dgvDSDocGia.CurrentRow.Cells[8].Value.;
            //String.Format("{0:0,0 VNĐ}", s);
            //txbTongNo.Text = dgvDSDocGia.CurrentRow.Cells[8].Value.ToString();
            //MessageBox.Show(dgvDSDocGia.CurrentRow.Cells[8].Value.ToString());
            txbTongNo.Text = dgvDSDocGia.CurrentRow.Cells[8].FormattedValue.ToString().Trim();
            errDC.Clear();
            errEmail.Clear();
            errLoaiDG.Clear();
            errTenDG.Clear();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            loadLoaiDG();
            setSizeCol();
            dgvDSDocGia.Columns[8].DefaultCellStyle.Format = "#,0 VNĐ";
            txbMaDG.Text = dgvDSDocGia.Rows[0].Cells[0].Value.ToString();
            txbHoTen.Text = dgvDSDocGia.Rows[0].Cells[1].Value.ToString();
            cbLoaiDG.Text = dgvDSDocGia.Rows[0].Cells[2].Value.ToString();
            dtpNgSinh.Text = dgvDSDocGia.Rows[0].Cells[3].Value.ToString();
            txbDChi.Text = dgvDSDocGia.Rows[0].Cells[4].Value.ToString();
            txbEmail.Text = dgvDSDocGia.Rows[0].Cells[5].Value.ToString();
            dtpNgLapThe.Text = dgvDSDocGia.Rows[0].Cells[6].Value.ToString();
            ...
            ketnoi(query);
            int tuoiMax = Convert.ToInt32(myCommand.ExecuteScalar());
            dtpNgSinh.MaxDate = DateTime.Now.AddYears(-tuoiMin);
            dtpNgSinh.MinDate = DateTime.Now.AddYears(-tuoiMax);
