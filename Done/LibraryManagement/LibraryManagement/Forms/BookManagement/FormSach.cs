...
namespace FormSach
{
    public partial class Form1 : Form
    {
        ...
        void loadDgv()
        {
            ...
            myConnection.Close();
            dgvSach.Columns[7].DefaultCellStyle.Format = "#,0 VNĐ";
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
           ...
           //txbSoLuongTon.Text = "0";
            ...
            txbMaSach.Text = dgvSach.Rows[0].Cells[0].Value.ToString();
            cbMaDS.Text = dgvSach.Rows[0].Cells[1].Value.ToString();
            cbTenSach.Text = dgvSach.Rows[0].Cells[2].Value.ToString();
            txbTenTG.Text = dgvSach.Rows[0].Cells[3].Value.ToString();
            dtpNamXuatBan.Value = DateTime.ParseExact(dgvSach.Rows[0].Cells[4].Value.ToString(), "yyyy", System.Globalization.CultureInfo.InvariantCulture);
            txbNhaXuatBan.Text = dgvSach.Rows[0].Cells[5].Value.ToString();
            txbSoLuongTon.Text = dgvSach.Rows[0].Cells[6].Value.ToString();
            txbGiaTien.Text = dgvSach.CurrentRow.Cells[7].FormattedValue.ToString().Trim();
