...
namespace FormNhapSach
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            txbMaPhieuNhap.Text = dgvPhieuNhap.Rows[0].Cells[0].Value.ToString();
            dtp_NgayNhap.Text = dgvPhieuNhap.Rows[0].Cells[1].Value.ToString();
            dgvPhieuNhap.Columns[2].DefaultCellStyle.Format = "#,0 VNĐ";
            txbTongTien.Text = dgvPhieuNhap.Rows[0].Cells[2].FormattedValue.ToString();
